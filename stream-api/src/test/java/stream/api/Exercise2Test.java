...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a1, a2) -> a2 - a1;
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(Comparator.comparing(Customer::getBudget).reversed()).map(Customer::getName).limit(3);
